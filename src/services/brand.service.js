...
module.exports.updateBrand =async  ({brandName,brandUrl,brandId}) =>  {
    ...
    try {
        console.log(chalk.greenBright('brand.service.js>>>updateBrand data service method>>>[try block]>>>[started] '));
        let query =  `UPDATE  brands SET brand_name=$1, brand_url=$2 WHERE brand_id=$3 RETURNING * ;`;
            ...
            console.log(chalk.greenBright('brand.service.js>>>updateBrand data service method [try block]>>>[finished] '));
