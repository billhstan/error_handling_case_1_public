//brand.service.js (using callback coding pattern and wrong raising error technique inside the createBrand )
...
module.exports.createBrand =  async ({brandName,brandUrl}) =>  {
    ...
    return new Promise(async(resolve,reject)=>{
        ...
        let query =  `INSERT INTO  brands (brand_name, brand_url) VALUES ($1,$2) RETURNING * ;`;
            client.query(query, [brandName,brandUrl] ,(error, result) => {
                if (error) {
                    let dataError=null;
